    ...
    public class XtraEditors_CN : Localizer
    {
        ...
        public override string GetLocalizedString(StringId id)
        {
            switch (id)
            {
                ...
                case StringId.ColorPickPopupAutomaticItemCaption: return "自动";
                case StringId.ColorPickPopupThemeColorsGroupCaption: return "主题颜色";
                case StringId.ColorPickPopupStandardColorsGroupCaption: return "标准色";
                case StringId.ColorPickPopupRecentColorsGroupCaption: return "a";
                case StringId.ColorPickPopupMoreColorsItemCaption: return "其它颜色";
                case StringId.ColorPickHueAxisName: return "色调";
                case StringId.ColorPickSaturationAxisName: return "饱和度";
                case StringId.ColorPickLuminanceAxisName: return "亮度调节";
                case StringId.ColorPickBrightnessAxisName: return "亮度";
                case StringId.ColorPickOpacityAxisName: return "透明度";
                case StringId.ColorPickRedValidationMsg: return "红色";
                case StringId.ColorPickGreenValidationMsg: return "绿色";
                case StringId.ColorPickBlueValidationMsg: return "蓝色";
                case StringId.ColorPickOpacityValidationMsg: return "透明度";
                case StringId.ColorPickColorHexValidationMsg: return "色值";
                case StringId.ColorPickHueValidationMsg: return "色调";
                case StringId.ColorPickSaturationValidationMsg: return "饱和度";
                case StringId.ColorPickBrightValidationMsg: return "亮度";
                case StringId.ColorTabWebSafeColors: return "WEB安全色";
